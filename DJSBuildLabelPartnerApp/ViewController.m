...
/// 策略1 ：分别弄成 名词 动词 副词 等每个label 弄成漂浮状态 旁边有气泡 显示在界面上
/// 策略2 ：只自定义一种label 然后让其随机赋值
...
//    _emitterLayer.seed = 1;
    ...
    cell.birthRate = 1.0;
    //发射角度
    //原来： cell.emissionRange = 0;
    cell.emissionRange = 0 * M_PI;
    //速度
    cell.velocity = 300;
    //范围
    //原来范围：150
